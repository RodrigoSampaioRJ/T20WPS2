	...
	public List<Carro> listaCarros() {
		...
		try {
			...
			while (rs.next()) {
				...
				listaCarros.add(new Carro(rs.getInt("COD_CARRO"), rs.getString("FABRICANTE"),
						         rs.getString("MODELO"), rs.getString("ANO"), rs.getString("COR"), rs.getString("CHASSI"), rs.getString("PLACA")));			
