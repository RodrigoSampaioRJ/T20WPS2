...
<body>
	...
	<div class="panel panel-primary">
		<div class="panel-heading">Painel de Clientes</div>


		<div class="form-group row">
			<div class="col-md-6">
				<a href="novo_cliente.jsp"><button type="button"
						class="btn btn-primary">Novo Cliente</button></a>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-md-4">
				<button type="button" class="btn btn-primary"
					onclick="findClienteByName();">Pesquisar</button>
			</div>
