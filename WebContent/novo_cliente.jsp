				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<input id="idCpf" name="cpf" placeholder="Apenas números"
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<input id="idRg" name="rg" placeholder="Apenas números"
									class="form-control input-md" required="" type="text"
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<input id="idHabilitacao" name="habilitacao"
						...
						<!-- Prepended text-->
						<div class="form-group row">
							<label class="col-md-5 control-label" for="prependedtext">Telefone
								<h11>*</h11>
							</label>
							<div class=" col-md-2 input-group" style="margin-bottom: 10px">
								<span class="input-group-addon"><i
									class="glyphicon glyphicon-earphone"></i></span> <input
									id="idTelefone1" name="prependedtext" class="form-control"
							...
							<div class=" col-md-2 input-group">
								<span class="input-group-addon"><i
									class="glyphicon glyphicon-earphone"></i></span> <input
									id="idTelefone2" name="prependedtext" class="form-control"
						...
						<!-- Prepended text-->
						<div class="form-group row">
							<label class="col-md-5 control-label" for="prependedtext">Email
								<h11>*</h11>
							</label>
							<div class="col-md-2">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-envelope"></i></span> <input id="idEmail"
						...
						<div class="form-group row">
							...
							<div class="col-md-2" style="margin-right: 10px">
								<input id="idCep" name="cep" placeholder="Apenas números"
									class="form-control input-md" required="" value=""
									type="search" maxlength="8" pattern="[0-9]+$">
							</div>
							<div class="col-md-4">
								<button type="button" class="btn btn-primary"
									onclick="pesquisacep();">Pesquisar</button>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-2 input-group">
								<span class="input-group-addon">Rua</span> <input id="idRua"
						...
						<div class="form-group row">
							...
							<div class="col-md-2 input-group">
								<span class="input-group-addon">Nº <h11>*</h11></span> <input
									id="idNumero" name="numero" class="form-control"
									placeholder="Número" required="" type="text">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-2 input-group">
								...
								<input id="idComplemento" name="complemento"
						...
						<div class="form-group row">
							...
							<div class="col-md-2 input-group">
								<span class="input-group-addon">Bairro</span> <input
									id="idBairro" name="bairro" class="form-control" placeholder=""
							...
							<div class="col-md-2">
								<div class="input-group">
									<span class="input-group-addon">Cidade</span> <input
										id="idCidade" name="cidade" class="form-control"
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<div class="input-group">
									<span class="input-group-addon">Estado</span> <input id="idUf"
						...
						<div class="row">
							<div class="col-md-6 control-label">
								<button type="button" class="btn btn-success" onclick="teste();">Cadastrar</button>
							</div>
